...
const SERVICES: ServiceDetail[] = [
  ...
  },
  {
    ...
    includes: [
      'Engaging daily activities tailored to residents\' interests',
      'Music, games, and creative pursuits',
      'Social outings and community events',
      'Comfortable shared spaces for gathering',
      'Outdoor seating areas and walking paths',
      'Encouragement of personal hobbies',
    ],
    reverse: true,
  },
]
